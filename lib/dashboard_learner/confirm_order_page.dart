  ...
  Future<void> _fetchUserData(String email) async {
    try {
      DocumentSnapshot userSnapshot =
          await _firestore.collection('learner_users').doc(email).get();
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () {
                        Firestore_Datasource().AddNote('Watch the Video', '${widget.data['name']}', 0);
                        Firestore_Datasource()
                            .AddNoteFirebase('Watch the Video', 'Watch Video', 0);
                        ctrl.addVideos(
                            widget.data['by'],
                            widget.data['level'],
                            widget.data['name'],
