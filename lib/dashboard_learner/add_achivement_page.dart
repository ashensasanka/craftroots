                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      ...
                      style: TextStyle(
                        fontSize:
                            16, // Change the font size to your desired value
                      ),
                    ),
                    SizedBox(
                      height: 20,
                    ...
                    Padding(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          contentPadding: EdgeInsets.fromLTRB(20, 5, 20,
                              5), // Adjust the padding (left, top, right, bottom)
                        ),
                      ),
                    ),
                    SizedBox(
                    ...
                    Row(
                      children: [
                        ...
                        ElevatedButton(
                          onPressed: () {
                            ctrl.addPost(_image, 'image', user!.uid);
                            showDialog(
                              context: context,
