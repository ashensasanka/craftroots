...
class ThirdAchivement extends StatefulWidget {
  const ThirdAchivement({super.key});

  @override
  State<ThirdAchivement> createState() => _FirstAchivementState();
}

class _FirstAchivementState extends State<ThirdAchivement> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: const Text('Achivement Three', style: TextStyle(fontWeight: FontWeight.bold)),
      ),
