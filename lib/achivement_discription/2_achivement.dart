...
class SecondAchivement extends StatefulWidget {
  const SecondAchivement({super.key});

  @override
  State<SecondAchivement> createState() => _FirstAchivementState();
}

class _FirstAchivementState extends State<SecondAchivement> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: const Text('Achivement Two', style: TextStyle(fontWeight: FontWeight.bold)),
      ),
