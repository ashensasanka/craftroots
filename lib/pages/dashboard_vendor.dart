...
import '../dashboard_vendor/order_details_vendor.dart';

class DashBoardVendor extends StatefulWidget {
  const DashBoardVendor({super.key});

  @override
  State<DashBoardVendor> createState() => _DashBoardVendorState();
}
...
class _DashBoardVendorState extends State<DashBoardVendor> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Dashboard_Vendor'),
        actions: [
          IconButton(
            onPressed: () async {
  ...
  Widget _buildPage(
      int index, AsyncSnapshot<DocumentSnapshot> documentSnapshot) {
    switch (index) {
      case 0: // Profile Page
        return Container(
          decoration: BoxDecoration(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildDetailRow(
                  'Password', documentSnapshot.data?.get('password')),
              _buildDetailRow(
                  'Location', documentSnapshot.data?.get('address')),
      ...
      case 1: // Material Request Page
        return StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance
              .collection('material_order')
              .where('number', isGreaterThan: '')
              .snapshots(),
          builder: (context, snapshot) {
                      ...
                      TextButton(
                        onPressed: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  OrderDetailsVendor(orderNumber: orderNumber),
                            ),
                          );
                        },
                        child: Text(
