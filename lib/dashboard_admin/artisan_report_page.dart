...
class ArtisanReportPage extends StatefulWidget {
  final String name;
  const ArtisanReportPage({super.key, required this.name});

  @override
  State<ArtisanReportPage> createState() => _ArtisanReportPageState();
}

class _ArtisanReportPageState extends State<ArtisanReportPage> {
  @override
          ...
          children: [
            ...
            ButtonWidget(
              ...
              onClicked: () async {
                ...
                final pdfFile = await PdfInvoicePdfHelper.generateartisan(invoice);
                PdfHelper.openFile(pdfFile);
                showDialog(
                  context: context,
                  builder: (_) => AlertDialog(
                    title: Text('Artisan Report Generated !'),
